// backend/tests/test_fresh_chat_display.js — Confirma que o chat atualizado abre com o guia padrão
...
async function run() {
  console.log('🚀 Testando exibição do chat após refresh...');
  ...
  try {
    ...
    // 4. Captura a imagem atual do chat
    await page.screenshot({ path: path.join(ARTIFACT_DIR, 'biblioteca_fresh_chat_verified.png') });
    console.log('📸 Captura do chat verificada salva.');
